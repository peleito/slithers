...
zlim([0,1])
axis equal
title('Vertical Helix','FontSize',titlesize/1,'Interpreter','latex')
...
zlim([0,1])
axis equal
title('Sine Wave','FontSize',titlesize/1,'Interpreter','latex')
...
zlim([0,1])
axis equal
title('Horizontal Helix','FontSize',titlesize/1,'Interpreter','latex')
...
% % zlim([0,1])
% % axis equal
% % title('Spiral Wave','FontSize',titlesize/1,'Interpreter','latex')
