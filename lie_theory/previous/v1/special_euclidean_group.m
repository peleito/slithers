classdef special_euclidean_group
    ...
    methods
        function obj = special_euclidean_group(matrix)
            %special_euclidean_group Construct an instance of this class
            %   Detailed explanation goes here
            obj.manifold = matrix;
        end
...
%         end
        ...
        function algebra = manifold_to_algebra(obj)
            %manifold_to_algebra Summary of this method goes here
            %   Detailed explanation goes here
            algebra = logm(obj.manifold);
        end
...
%         end
        ...
        function vector = manifold_to_vector(obj)
            %manifold_to_vector Summary of this method goes here
            %   Detailed explanation goes here
            algebra = manifold_to_algebra(obj,obj.manifold);
            vector = algebra_to_vector(obj,algebra);
        end
