...
pose = step_forward(parameters.screws,[pi,1],dof)*parameters.config_state
...
pose = step_forward(parameters.screws,inverse,dof)*parameters.config_state
...
inverse = ik_optimization(x, xdot, ee_desired, parameters)
pose = pose*step_forward(parameters.screws,inverse,dof)*parameters.config_state
